...
models2 = [
    ...
    # ['x2b',
    # ['sex', 'x2a', 'x5a'],
    # [-11.851235292947143, 0.505041285098282, -0.35578129788208845, 23.8283000527611]
    # ],
    # ['x3b',
    # [],
    # [32.18029411764706]
    ...
    ['x6b',
    ['age/x3a*u2', 'age/x5a', 'x2a/x6a*u2'],
    [-0.03345917163933225, 10.855443669244014, -0.025106966033139735, 123.37323266614385]
    ],
    ['x7b',
    ['x7a', 'x8a', 'age/x2a*u2', 'age*x3a'],
    [0.5468230770665058, -0.0021259521808294655, -0.004994643318391339, 0.00042049665276516486, 4.516058227105834]
    ],
    # ['x8b',
    # ['x8a'],
    # [0.41761513283538954, 73.47001847972102]
    # ]
]
